document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    ...
    en: {
      ...
      "videoPage.hero.description": "Curated brand spots, product demos, and real-life scenarios help you grasp the key features and experiences of every hero product in minutes.",
      "videoPage.overview.title": "Content Highlights",
      "videoPage.overview.description": "Focused on fresh kitchen ideas, efficient cleaning, and comfortable living themes, updated regularly to reflect real household needs.",
      "videoPage.overview.card1.title": "Kitchen Inspiration",
      "videoPage.overview.card1.description": "From portable juicers to multi-function cookers, see how premium appliances elevate everyday cooking.",
      "videoPage.overview.card2.title": "Cleaning Tech",
      "videoPage.overview.card2.description": "Steam mops, wall-mounted laundry care, and more bring efficient, hygienic routines to life.",
      "videoPage.overview.card3.title": "Comfort Upgrades",
      "videoPage.overview.card3.description": "Discover neck fans, smart hydration, and other lifestyle picks that keep every season comfortable.",
      "videoPage.featured.badge": "FEATURED",
      "videoPage.featured.description": "A lightweight juicer set with dual cups and a magnetic motor—watch how it fits outdoor, office, and home scenarios, along with cleaning and safety tips.",
      "videoPage.featured.bullet1": "Step-by-step demo of juicing, cup separation, and take-and-go sipping.",
      "videoPage.featured.bullet2": "Covers Type-C charging and smart travel storage tips.",
      "videoPage.featured.bullet3": "Perfect for style-conscious families who value convenience and healthy living.",
      ...
      "videoPage.collections.description": "Filter by theme to quickly find demos that match your lifestyle needs.",
      ...
      "videoPage.cards.zb8.description": "Lightweight and portable, demonstrates three-speed blending plus the double-tap safety start.",
      ...
      "videoPage.cards.k10.description": "Showcases independent upper/lower heating, rich accessories, and multiple recipes for low-oil cooking.",
      "videoPage.cards.f20.description": "Highlights summer commuting scenarios with four fan speeds, flexible airflow, and long battery life.",
      "videoPage.cards.dyks01.description": "Explains four temperature presets, dual safety protection, and dechlorination for all-day hydration.",
      "videoPage.cards.dybgx09.description": "Demonstrates space-saving wall mounting, baby-care programs, and 60°C sanitizing cycles.",
      "videoPage.cards.dybgx09h.description": "Upgraded heat-pump drying and sanitizing, with tips on load planning and installation.",
      "videoPage.cards.db01.description": "Shows rapid drying plus steam ironing, including travel packing tips and garment care advice.",
      "videoPage.cards.dybm05.description": "Morning kitchen scenes highlight slow-press juicing, easy cleanup, and toddler-friendly recipes.",
      ...
      "videoPage.cards.dyzm1266.description": "Compact multi-function cooking covers soups, hotpot, and solo meals with a clear lid and detachable pot.",
      "videoPage.note.title": "More videos coming soon",
      "videoPage.note.description": "We update the center with product launches, installation guides, and customer stories. Need demos or training materials? Contact your DAEWOO representative.",
